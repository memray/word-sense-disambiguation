...
import GAS_ext.model_plus as model_plus
...
def feed_dict(batch_data, is_training=True):
    ...
    feeds = {
        ...
        model.hyper_lenth: hyper_lenth,
        model.hypo_lenth: hypo_lenth,
    }
    return feeds
...
def evaluate(eval_data, step=None):
    ...
    for batch_id, batch_data in enumerate(
        ...
        # summary_val_writer.add_summary(summary, step)  # add summary of each step
...
if __name__ == "__main__":
    ...
    # train summary
    train_log_dir = '../tmp/tf.log/GAS_ext/train'
